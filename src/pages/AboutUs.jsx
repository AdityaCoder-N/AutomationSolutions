...
const AboutUs = () => {
  ...
  return (
    <div className='py-10 px-6 md:px-16'> 
      ...
      <div className='bg-[#084C83] w-full rounded-xl md:rounded-3xl flex relative items-center justify-between'>

        <img src={whiteBox} alt="" className=' h-[15rem] md:h-full w-2/3 md:w-[50%]'/>

        <div className='absolute left-4 md:left-12 top-1/2 -translate-y-1/2 w-1/2 md:w-1/3'>
          <h1 className='text-black text-lg md:text-2xl lg:text-4xl font-bold'>About Us</h1>
          <p className='text-black my-3 lg:my-6 text-xs md:text-base lg:text-xl '>Synthwave Technologies leads the way in providing cutting-edge Machine Learning and Artificial Intelligence solutions, transforming businesses through innovation.</p>

          <button className='bg-[#084C83] font-semibold text-xs md:text-base py-[0.5rem] md:py-2 px-4 rounded-lg shadow-lg'>Explore More</button>
        </div>

        <img src={objects} alt="" className='hidden lg:block h-3/4 mr-16'/>

      </div>

      <h1 className='text-4xl font-bold text-center mt-20'>Why our Services are Unique</h1>
      {/* service list */}
      <div className='my-8 p-4 px-0 md:px-20' >
      ...
      <div className='px-0 lg:px-6 py-4 sm:py-10 grid grid-cols-1 md:grid-cols-2 gap-14 '>
        ...
        <div className='flex w-full gap-6'>
          ...
          <div className='flex flex-col gap-4 w-3/4'>
            <h1 className='text-lg sm:text-3xl font-semibold'>Vision</h1>
            <p className='text-xs sm:text-lg leading-6'>Our vision is to be at the forefront of innovation in ML and AI, transforming industries, and improving lives through data-driven insights and intelligent solutions. We aim to create a world where businesses harness the full potential of data to achieve their goals.</p>
          </div>
        ...
        <div className='flex w-full gap-6'>
          ...
          <div className='flex flex-col gap-4 w-3/4'>
            <h1 className='text-lg sm:text-3xl font-semibold'>Mission</h1>
            <p className='text-xs sm:text-lg leading-6'>Our mission is to empower organizations with cutting-edge ML and AI services that drive growth, efficiency, and innovation. We are dedicated to delivering tailored solutions that solve complex challenges, guided by principles of ethics, transparency, and client-centricity.</p>
          </div>
        ...
        <div className='flex w-full gap-6'>
          ...
          <div className='flex flex-col gap-4 w-3/4'>
            <h1 className='text-lg sm:text-3xl font-semibold'>Ethical Practices</h1>
            <p className='text-xs sm:text-lg leading-6'>We prioritize ethical AI and data privacy, ensuring that our solutions are fair, transparent, and accountable.</p>
          </div>
        ...
        <div className='flex w-full gap-6'>
          ...
          <div className='flex flex-col gap-4 w-3/4'>
            <h1 className='text-lg sm:text-3xl font-semibold'>Long Term Partnership</h1>
            <p className='text-xs sm:text-lg leading-6'>We're not just a service provider; we're a partner in your journey. We're dedicated to building long-lasting relationships and supporting your growth</p>
          </div>
      ...
      <h1 className='text-center font-bold text-4xl my-4 sm:my-12 mt-20'>Our Story</h1>

      <div className='relative w-full'>
        <img src={chat} alt="" className='h-full w-full' style={imageStyle}/>

        <div className='absolute top-[60%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 flex flex-col gap-4 md:gap-10'>
          <p className='text-xs md:text-lg lg:text-2xl w-full text-center'>
          ...
          <p className='hidden sm:block  text-xs md:text-lg lg:text-2xl w-full text-center'>
      ...
      <p className='text-xs sm:text-lg text-center my-2 md:my-5'>Choosing Synthwave Technologies means choosing a partner committed to your success. Here's why clients trust us: Proven Results - Our track record of successful projects and satisfied clients speaks to our ability to deliver tangible results.</p>

      <div className='px-0 lg:px-4 py-16 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10'>
        ...
        <p className='text-xs sm:text-lg text-center my-0 sm:my-5 w-[90%] md:w-2/3 ml-[50%] -translate-x-1/2'>
